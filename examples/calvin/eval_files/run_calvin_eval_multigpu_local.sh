...
SERVER_READY_TIMEOUT=${SERVER_READY_TIMEOUT:-0}
STARVLA_CALVIN_RENDER_BACKEND=${STARVLA_CALVIN_RENDER_BACKEND:-direct}
USE_BF16=${USE_BF16:-1}
...

{
  ...
  echo "SERVER_READY_TIMEOUT=${SERVER_READY_TIMEOUT} (0 means wait forever)"
